...
function Footer() {
  ...
  return (
    <footer className="bg-gray-200 py-8 px-4 md:px-32">
      <div className="container mx-auto flex flex-wrap justify-between   border-b border-gray-400">
        <div className="w-full md:w-1/2 lg:w-1/4">
          <div className="text-2xl font-bold mb-4 flex items-center">
            <img className="h-10 w-10 mr-2" src="./images/karwaanlogo.jpg" alt="Karwaan Logo" />
            <span className="text-blue-500 font-bold" style={{ fontFamily: 'Poppins' }}>
              Kaarwaan
            </span>
          </div>
          ...
          <div className="mt-4 md:mt-12">
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/kaarwaanjec/" className="text-2xl" target="_blank" rel="noreferrer">
                <FaFacebook />
              </a>
              <a href="https://www.youtube.com/@kaarwaanjec9417" className="text-2xl" target="_blank" rel="noreferrer">
                <FaYoutube />
              </a>
              <a href="https://www.linkedin.com/company/kaarwaa-n/" className="text-2xl" target="_blank" rel="noreferrer">
                <FaLinkedin />
              </a>
              <a href="https://www.instagram.com/kaarwaa.n/" className="text-2xl" target="_blank" rel="noreferrer">
                <FaInstagram />
              </a>
            </div>
          </div>
        ...
        <div className="w-full md:w-1/2 lg:w-1/4">
          ...
          <ul className="text-sm font-light space-y-4 pb-4">
            ...
            <li>
              <button onClick={() => setShowCertificateForm(true)} className="hover:text-blue-400">
        ...
        <div className="w-full md:w-1/2 lg:w-1/4 justify-end">
