      ...
      <div id="about" className="flex aboutdiv my-20 pt-20 flex-row">
        <div className="flex detailsdiv flex-col w-1/2">
          ...
          <div className="w-full aboutdetails py-4 p-12 pl-32 h-full">
            <p>
              Kaarwaa.N is a social welfare association founded by the students of Jabalpur Engineering College (JEC), Jabalpur. We are dedicated to helping the poor, underprivileged, downtrodden sections of society. The primary aim of Kaarwaa.N is to tutor students for the JNV (Jawahar Navodaya Vidhyalaya) Entrance Exam and encourage “girls’ education”.
            </p>
            <p>
              We organize innumerable activities to help the marginalized and create awareness about various social issues. Addressing issues from health and hygiene to education and the environment, the members of Kaarwaa.N believe in working towards making this world a better place.
              <Link to="/aboutus">
        ...
        <div className="card overflow-hidden">
          ...
          <div className="detailstoshow bg-[#9EA3B0]">
            ...
            <p className="px-4 pb-2">
              Nukkad nataks - a form of street theater performed by the members to create awareness amongst people regarding various social issues. 
            </p>
