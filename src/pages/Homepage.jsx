...
\
      ...
      <div id="home" className="px-12 pt-20 gap-44 items-center flex justify-center lg:h-screen h-full w-full home">
        <div className="pl-20 taglinediv">
          <h1 className="text-6xl tagline w-3/5 pr-20 text-[#4A6C6F] font-semibold">
...
A step for the welfare of another India.
          ...
          <div className="h-auto flex justify-center gap-6 py-6 w-[20rem] ">
            <Link to="/Donation">
            <button className="border-2 flex flex-row justify-center items-center gap-2 font-semibold text-[#4A6C6F] px-4 py-1 rounded-full bg-[#40b186] hover:bg-[#00684C] hover:text-[#B7D9BF] duration-300 hover:border-2 hover:border-[#24387a]">
      ...
      <div id="about" className="flex aboutdiv my-20 pt-20 flex-row">
        <div className="flex detailsdiv flex-col w-1/2">
          <div className="w-full py-4 p-12 pl-32 h-full flex items-start abouthread text-[#4A6C6F] flex-col bg-[#40B186]">
      ...
      <div className="flex flex-col items-center h-full text-[#4A6C6F] w-full px-32 py-12 bg-[#40B186] programbg">
        <h1 className="text-6xl text-center">Counter of the Karwaa.N... works</h1>
        <p className="programdata text-center w-2/3 text-sm mt-6">
          Karwaa.N... has taught the children along with many pro-society works
          Like Cloth Donations, Tree Plantation, Book Donations etc.
          Below is a counter for all the works.
      ...
      <h1 id="ourwork" className="text-4xl pt-65 font-semibold my-20 mt-32 text-center text-[#4A6C6F] bg-[#40B186]">
